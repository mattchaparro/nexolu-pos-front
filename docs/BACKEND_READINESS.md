...
| Cuentas abiertas | ✅ Listo | `tables`, `open-tabs` (+ items/partial-payments/close). El hueco de `CloseOpenTabRequest` (fiado sin dato de cliente, mismo bug que `StoreSaleRequest` tenia) ya se corrigio. |
