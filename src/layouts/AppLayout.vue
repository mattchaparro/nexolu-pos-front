...
// La pantalla montada registra su recorrido; si no hay ninguno, el signo de
// pregunta de la barra no se dibuja (ver useGuidedTour).
    ...
    <div class="flex min-h-0 flex-1">
      ...
      <div class="flex min-w-0 flex-1 flex-col">
        <NxNavbar
          ...
          :has-tour="activeTour !== null"
          @logout="handleLogout"
          @start-tour="activeTour?.start(true)"
        >
          <template #actions>
            <BranchSwitcher />
            <RouterLink
