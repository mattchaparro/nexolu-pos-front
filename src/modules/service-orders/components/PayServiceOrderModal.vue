...
<template>
  ...
  >
    <div v-if="order" class="flex flex-col gap-4">
      ...
      <NxInputNumber v-model="amount" label="Monto a abonar" :min="0" :max="order.balance" />
    ...
    <template #footer>
      <div class="flex gap-2">
        ...
        <NxButton class="flex-[2]" :disabled="!canSubmit" :loading="payMutation.isPending.value" @click="submit">
          Confirmar abono
        </NxButton>
      </div>
    </template>
