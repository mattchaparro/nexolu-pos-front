...
function openStockModal(subject: StockSubject): void {
...
<template>
  <div class="flex flex-col pb-20 lg:pb-0">
                        ...
                        <template #body="{ data }: { data: Product }">
                          <div class="flex items-center justify-end gap-2.5">
                            <button
                              ...
                              title="Ajustar stock"
                              @click="openStockModal({ kind: 'product', id: data.id, name: data.name, stock: data.stock })"
                            >
                        ...
                        <template #body="{ data }: { data: Ingredient }">
                          <div class="flex items-center justify-end gap-2.5">
                            <button
                              ...
                              class="text-slate-400 hover:text-indigo-600"
                              title="Ajustar stock"
                              @click="openStockModal({ kind: 'ingredient', id: data.id, name: data.name, stock: Number(data.stock), unit: data.unit })"
                            >
                              <i class="pi pi-sliders-h text-sm" />
                            </button>
                            <button
    ...
    <StockMovementModal v-model="stockModalOpen" :subject="stockSubject" />
  </div>
</template>
