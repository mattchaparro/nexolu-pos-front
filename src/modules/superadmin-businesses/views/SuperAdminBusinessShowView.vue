...
import { NxButton, NxPageHeader, NxStatCard } from '@/ui'
    ...
    <template v-else-if="detail">
      ...
      <div class="rounded-xl border border-slate-200 bg-white">
        <div class="border-b border-slate-100 px-4 py-3">
          <p class="text-sm font-semibold text-slate-700">Equipo</p>
        </div>
      ...
      <div v-if="detail.recent_subscription_payments.length" class="overflow-x-auto rounded-xl border border-slate-200 bg-white">
        <p class="border-b border-slate-100 px-4 py-3 text-sm font-semibold text-slate-700">Pagos de suscripción recientes</p>
